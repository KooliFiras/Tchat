 ...
 */
class PasswordManagementController extends FOSRestController implements ClassResourceInterface
{
    ...
    public function requestResetAction(Request $request)
    {
        ...
        if (null !== $event->getResponse()) {
          ...
          $this->get('fos_user.mailer')->sendResettingEmailMessage($user);  // calls the route fos_user_resetting_reset which we didn't import it to fix that let's create our own Mailer service
